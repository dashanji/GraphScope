...
class Session(object):
    ...
    def __init__(
        ...
        vineyard_deployment_name=gs_config.vineyard_deployment_name,
        ...
        **kw,
        ...
        Args:
            ...
            vineyard_deployment_name (str, optional): The name of vineyard deployment to use. GraphScope will try to
